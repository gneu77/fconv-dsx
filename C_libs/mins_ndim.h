...
struct Powell : Linemethod<T> {
    ...
    const Doub ftol;
//    const Doub max_func_val;
    Powell(T &func, const Doub ftoll=3.0e-8/*, Doub max_f_val = 9999999999.*/) : Linemethod<T>(func),
        ftol(ftoll)/*, max_func_val(max_f_val)*/ {}
