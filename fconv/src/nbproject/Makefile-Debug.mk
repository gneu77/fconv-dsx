...
# CC Compiler Flags
CCFLAGS=-pedantic -Wall -m32 -D_LINUX_OS
CXXFLAGS=-pedantic -Wall -m32 -D_LINUX_OS
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/fconv

dist/Debug/GNU-Linux-x86/fconv: ${OBJECTFILES}
...
${OBJECTDIR}/fconv.o: fconv.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../C_libs -MMD -MP -MF $@.d -o ${OBJECTDIR}/fconv.o fconv.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/fconv
