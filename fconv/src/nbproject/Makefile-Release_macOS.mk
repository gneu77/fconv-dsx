...
# CC Compiler Flags
CCFLAGS=-pedantic -Wall -m32
CXXFLAGS=-pedantic -Wall -m32
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release_macOS.mk dist/Release_macOS/GNU-Linux-x86/fconv

dist/Release_macOS/GNU-Linux-x86/fconv: ${OBJECTFILES}
	${MKDIR} -p dist/Release_macOS/GNU-Linux-x86
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release_macOS
	${RM} dist/Release_macOS/GNU-Linux-x86/fconv
