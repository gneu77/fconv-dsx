...
CND_CONF=Mac_Release_nonstatic_32
CND_DISTDIR=dist
...
# CC Compiler Flags
CCFLAGS=-m32 -pedantic -Wall
CXXFLAGS=-m32 -pedantic -Wall
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Mac_Release_nonstatic_32.mk dist/Mac_Release_nonstatic_32/GNU-Linux-x86/dsx

dist/Mac_Release_nonstatic_32/GNU-Linux-x86/dsx: ${OBJECTFILES}
	${MKDIR} -p dist/Mac_Release_nonstatic_32/GNU-Linux-x86
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dsx ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/drugscoreX.o: drugscoreX.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../C_libs -MMD -MP -MF $@.d -o ${OBJECTDIR}/drugscoreX.o drugscoreX.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Mac_Release_nonstatic_32
	${RM} dist/Mac_Release_nonstatic_32/GNU-Linux-x86/dsx
