...
# CC Compiler Flags
CCFLAGS=-m32 -pedantic -Wall -D_LINUX_OS
CXXFLAGS=-m32 -pedantic -Wall -D_LINUX_OS
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release_nonstatic.mk dist/Release_nonstatic/GNU-Linux-x86/dsx

dist/Release_nonstatic/GNU-Linux-x86/dsx: ${OBJECTFILES}
	${MKDIR} -p dist/Release_nonstatic/GNU-Linux-x86
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release_nonstatic
	${RM} dist/Release_nonstatic/GNU-Linux-x86/dsx
