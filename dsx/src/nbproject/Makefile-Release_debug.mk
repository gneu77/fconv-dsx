...
# CC Compiler Flags
CCFLAGS=-static -pedantic -Wall -m32 -D_LINUX_OS -D_DSX_DEBUG
CXXFLAGS=-static -pedantic -Wall -m32 -D_LINUX_OS -D_DSX_DEBUG
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release_debug.mk dist/Release_debug/GNU-Linux-x86/dsx

dist/Release_debug/GNU-Linux-x86/dsx: ${OBJECTFILES}
	${MKDIR} -p dist/Release_debug/GNU-Linux-x86
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release_debug
	${RM} dist/Release_debug/GNU-Linux-x86/dsx
