...
# CC Compiler Flags
CCFLAGS=-m64 -pedantic -Wall -D_LINUX_OS
CXXFLAGS=-m64 -pedantic -Wall -D_LINUX_OS
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release_nonstatic_64.mk dist/Release_nonstatic_64/GNU-Linux-x86/dsx

dist/Release_nonstatic_64/GNU-Linux-x86/dsx: ${OBJECTFILES}
	${MKDIR} -p dist/Release_nonstatic_64/GNU-Linux-x86
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release_nonstatic_64
	${RM} dist/Release_nonstatic_64/GNU-Linux-x86/dsx
