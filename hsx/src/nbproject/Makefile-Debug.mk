...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/hotspotsx

dist/Debug/GNU-Linux-x86/hotspotsx: ${OBJECTFILES}
...
${OBJECTDIR}/hotspotsX.o: hotspotsX.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../C_libs -MMD -MP -MF $@.d -o ${OBJECTDIR}/hotspotsX.o hotspotsX.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/hotspotsx
