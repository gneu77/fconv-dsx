...
# CC Compiler Flags
CCFLAGS=-static -pedantic -Wall -m32 -D_LINUX_OS -fopenmp
CXXFLAGS=-static -pedantic -Wall -m32 -D_LINUX_OS -fopenmp
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-OMP_Debug.mk dist/OMP_Debug/GNU-Linux-x86/hotspotsx_omp

dist/OMP_Debug/GNU-Linux-x86/hotspotsx_omp: ${OBJECTFILES}
	${MKDIR} -p dist/OMP_Debug/GNU-Linux-x86
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hotspotsx_omp ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/hotspotsX_omp.o: hotspotsX_omp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../C_libs -MMD -MP -MF $@.d -o ${OBJECTDIR}/hotspotsX_omp.o hotspotsX_omp.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/OMP_Debug
	${RM} dist/OMP_Debug/GNU-Linux-x86/hotspotsx_omp
