...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release_MT.mk dist/Release_MT/GNU-Linux-x86/hotspotsx_mt

dist/Release_MT/GNU-Linux-x86/hotspotsx_mt: ${OBJECTFILES}
	${MKDIR} -p dist/Release_MT/GNU-Linux-x86
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release_MT
	${RM} dist/Release_MT/GNU-Linux-x86/hotspotsx_mt
