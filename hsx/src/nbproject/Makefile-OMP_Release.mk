...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-OMP_Release.mk dist/OMP_Release/GNU-Linux-x86/hotspotsx_omp

dist/OMP_Release/GNU-Linux-x86/hotspotsx_omp: ${OBJECTFILES}
	${MKDIR} -p dist/OMP_Release/GNU-Linux-x86
	${LINK.cc} -fopenmp -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hotspotsx_omp ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/hotspotsX_omp.o: hotspotsX_omp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../C_libs -fopenmp -MMD -MP -MF $@.d -o ${OBJECTDIR}/hotspotsX_omp.o hotspotsX_omp.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/OMP_Release
	${RM} dist/OMP_Release/GNU-Linux-x86/hotspotsx_omp
