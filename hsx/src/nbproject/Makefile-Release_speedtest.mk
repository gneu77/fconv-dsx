...
# CC Compiler Flags
CCFLAGS=-static -pedantic -Wall -m32 -D_LINUX_OS -D_SPEEDTEST
CXXFLAGS=-static -pedantic -Wall -m32 -D_LINUX_OS -D_SPEEDTEST
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release_speedtest.mk dist/Release_speedtest/GNU-Linux-x86/hotspotsx_speedtest

dist/Release_speedtest/GNU-Linux-x86/hotspotsx_speedtest: ${OBJECTFILES}
	${MKDIR} -p dist/Release_speedtest/GNU-Linux-x86
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hotspotsx_speedtest ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/hotspotsX.o: hotspotsX.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../C_libs -MMD -MP -MF $@.d -o ${OBJECTDIR}/hotspotsX.o hotspotsX.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release_speedtest
	${RM} dist/Release_speedtest/GNU-Linux-x86/hotspotsx_speedtest
